public class DeckBuilder {
    ...
    public static Deck createStarterDeck() {
        ...
        // Add Pokémon cards (our 5 sample cards)
        deck.addCard(createLardiosLardias());
        deck.addCard(createNigamath());
        deck.addCard(createSuhasStroll());
        deck.addCard(createCrusader());
        deck.addCard(createVedanth());
        
        // Add energy cards (15 cards)
        for (int i = 0; i < 3; i++) {
            deck.addCard(new EnergyCard("Fire", "Fire", 1));
            deck.addCard(new EnergyCard("Water", "Water", 1));
            deck.addCard(new EnergyCard("Grass", "Grass", 1));
            deck.addCard(new EnergyCard("Lightning", "Lightning", 1));
            deck.addCard(new EnergyCard("Psychic", "Psychic", 1));
        }
     ...
     */
    public static PokemonCard createLardiosLardias() {
     ...
     */
    public static PokemonCard SuhasStroll() {
     ...
     */
    public static PokemonCard Crusader() {
     ...
     */
    public static PokemonCard Vedanth() {
